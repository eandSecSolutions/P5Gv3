...
(function(){
  ...
  const COPY={
    ...
    ar:{
      title:'لماذا شبكة 5G خاصة؟',
      subtitle:'شبكة 5G الخاصة تمنح العمليات الحرجة طبقة اتصال لاسلكية آمنة ومحكومة ومرنة للفرق الميدانية والأصول والحساسات ومراكز القيادة.',
      tabs:['قيمة شبكة 5G الخاصة','البنية التحتية والتحكم والأمان','استمرارية الاتصال في الظروف الحرجة'],
